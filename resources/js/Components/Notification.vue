<template>
  <transition name="fade">
    <div v-if="visible"
      ...
      <div class="flex">
        <div class="py-1">
          <svg class="fill-current h-6 w-6 mr-4" :style="`color: ${color};`" xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 20 20">
            <path
        ...
        <button @click="closeNotification" class="ml-auto transition-colors duration-200" :style="`color: ${color};`"
          aria-label="Close">
