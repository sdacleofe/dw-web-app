<template>
  ...
  >
    <div class="bg-white rounded-2xl p-8 min-w-[340px] max-w-[95vw] border border-blue-200 shadow-2xl animate-fade-in relative">
      <button
        @click="$emit('close')"
      ...
      <div class="space-y-3">
        ...
        <div v-if="column">
          ...
          <span class="ml-1 px-2 py-1 rounded bg-blue-50 text-blue-800 font-mono text-base">{{ column }}</span>
        </div>
